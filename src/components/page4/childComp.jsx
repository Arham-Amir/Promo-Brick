      ...
      <section>
        <section className='flex flex-row items-center justify-end ms:justify-between w-4/5 mx-auto pt-5'>
          <section className='hidden ms:flex flex-row gap-3 items-center'>
            ...
            <p className='text-lg'><Link className='hover:text-themeColor' href="/">Home</Link>/Design Borders</p>
          </section>
      ...
      <div className="flex md:flex-row xs:flex-col-reverse xs:h-auto md:h-[70vh] w-full md:w-4/5 mx-auto px-5 py-2 my-8">
        <div className="relative xs:h-fit xs:py-8 md:py-0 md:h-full xs:w-full md:w-1/2 px-7 flex flex-col justify-center items-end gap-6">
          ...
          <div className="relative z-20 flex flex-col gap-5 w-full">
            <h1 className="text-5xl font-bold font-heading">Design Borders</h1>
            <p className="text-base font-medium w-full md:w-11/12 font-text">
              Design Borders are also known as Brick Borders, can be used internally or externally to create a modern or traditional brick finish that is indistinguishable from that of a regular brick in the majority of cases, Design Borders are the thin cut sections of Facing Bricks & Slips.
            </p>
            <p className="text-base font-medium w-full md:w-11/12 font-text">
              They are able to reduce overall build schedules and allow for a cleaner site with less storage and handling requirements than regular bricks would require. Design Borders are highly versatile and are able to transform internal and external walls, quickly and cost effectively.
            </p>
          </div>
        </div>
