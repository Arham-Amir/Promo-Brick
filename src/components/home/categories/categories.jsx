...
export default function Categories() {
  const content = [
    ...
    ['#62A86B', 'Facing Bricks & Slips', "Facing brick that is not needed just for the structure, but also for look, Designed, efficiency and value. You can see face bricks in homes, commercial buildings, public places,and etc.", '/page3', '/images/facingbg.jpg'],
    ['#9BD3C4', 'Design Borders', "Design Borders are specially manufactured tiles from Facing Bricks & Slips,when they are installed, they have the appearance, color and texture of a real clay brick wall.", '/page4', '/images/brickslipsbg.png'],
