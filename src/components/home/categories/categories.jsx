...
export default function Categories() {
  const content = [
    ['#EC6839', 'Merchants', "Supporting builders' merchants nationwide"],
    ['#62A86B', 'Architects', "Inovative design, traditional solutions"],
    ['#F2A644', 'Developers', "Complete aesthetic build solutions"],
    ['#9BD3C4', 'Self Builders', "Everyting for building, renovating, or extending your own home"],
    ['#AB8FE5', 'Contractors', "Quality products for quality builds"]
  ]
  return (
    <div className='relative bg-gray-700'>
      {/* <div>
            <img className="w-screen max-h-[50vh] object-cover" src="/images/brick.jpg" alt="Bricks" />
        </div> */}
