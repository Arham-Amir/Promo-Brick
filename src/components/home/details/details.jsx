...
const Details = () => {
  return (
    <section className="h-auto border-y-4 border-white max-w-screen">
      <section className="bg-bgLight h-full">
        <section className="h-auto bg-[#cd2122] px-20 py-20 flex flex-col  gap-4 text-white">
          <p className="w-20 p-[2px] bg-white"></p>
          <h1 className="text-3xl font-bold">Promo Bricks (PVT) LTD</h1>
          <section className="flex justify-between items-start">
            ...
            <button className="-translate-y-4 px-5 py-3 border-2 h-fit min-w-fit mr-5 z-0">Learn More</button>
          </section>
        </section>
