    ...
    <section className="bg-gradient-to-br from-[#0c0c0c] to-[#393939] flex flex-col">
      ...
      <section className="border-b-2 py-3 w-11/12 mx-auto text-white flex flex-col gap-2">
        ...
        <section className="flex flex-row gap-7 items-center w-fit mx-auto py-2 text-white">
          <a className='border rounded-full p-2 hover:border-yellow-500' href='https://www.facebook.com/profile.php?id=100066721054138&mibextid=ZbWKwL' target="_blank"><BsFacebook size={25}></BsFacebook></a>
          <a className='border rounded-full p-2 hover:border-yellow-500' href='https://www.facebook.com/profile.php?id=100066721054138&mibextid=ZbWKwL' target="_blank"><BsInstagram size={25}></BsInstagram></a>
          <a className='border rounded-full p-2 hover:border-yellow-500' href='https://www.facebook.com/profile.php?id=100066721054138&mibextid=ZbWKwL' target="_blank"><BsLinkedin size={25}></BsLinkedin></a>
          <a className='border rounded-full p-2 hover:border-yellow-500' href='https://www.youtube.com/@promobrick1914' target="_blank"><BsYoutube size={25}></BsYoutube></a>
        </section>
      </section>
