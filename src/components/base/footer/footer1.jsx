    ...
    <div className="bg-gradient-to-br from-[#0c0c0c] to-[#393939] text-xs w-screen border-t-4 border-white">
      <section className='flex justify-center items-center h-full'>
        <div className="px-16 flex flex-wrap text-white justify-between items-start min-h-max w-full py-10 overflow-hidden text-sm">
          ...
          <div className="ms:w-1/4 mt-9 md:mt-0 xs:w-fit flex flex-col items-start md:p-10" >
            <h2 className="mb-4 text-2xl font-bold">Address</h2>
            <p className="mt-2 w-full md:w-3/5 leading-6">
          ...
          <div className="w-full ms:w-1/4 mt-9 md:mt-0 sm:w-1/2 flex flex-col items-start md:p-10" >
            <h2 className="mb-4 text-2xl font-bold">Contact Us</h2>
            <div className="mt-3 min-w-fit flex">
      ...
      <hr className="hidden md:block w-11/12 mx-auto bg-slate-300" />
